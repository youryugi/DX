...
# 为了在同一窗口添加slider和button，需要调整figure布局
...
# 按钮：Generate Path
ax_button_generate = plt.axes([0.8, 0.15, 0.1, 0.075])
