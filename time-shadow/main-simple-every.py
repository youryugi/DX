...
shadow_file = "shadows_20241205_1300_1400_5min.pkl"
...
def update_cool_route(coef, start_time):
    shadow_lengths = []
    ...
    for idx, row in gdf_edges.iterrows():
        ...
        # 取这段edge的中点时间
        mid_time = current_time + timedelta(seconds=travel_time_s / 2)
        ...
        #lambda = coef  # 你可以决定怎么映射 slider → lambda
